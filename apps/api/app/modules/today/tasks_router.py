...
from app.modules.today import suggest_day as suggest_day_svc
from app.modules.today import tasks as task_svc
from app.modules.today import task_planner as task_planner
...
async def summary(
    ...
    d = day or user_local_today(user.timezone)
    return await task_svc.task_summary(db, user.id, d, timezone=user.timezone)
